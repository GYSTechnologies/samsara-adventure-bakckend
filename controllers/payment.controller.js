...
exports.verifyPayment = async (req, res) => {
  ...
  try {
    ...
    const bookingDoc = {
      ...
      current_location: bookingData.pickupLocation || "",
      total_members: (bookingData.adults || 0) + (bookingData.children || 0),
      adults: bookingData.adults || 0,
      childrens: bookingData.children || 0,
      tripType: bookingData.tripDetails?.tripType || "PACKAGE",
      isPaymentPending: false,
      isPaymentUpdated: true,
      payment: {
        subtotal: bookingData.tripDetails?.payment?.subTotal || 0,
        taxation: bookingData.tripDetails?.payment?.taxation || 0,
        insurance: bookingData.tripDetails?.payment?.insurance || 0,
        activities: bookingData.tripDetails?.payment?.activities || 0,
