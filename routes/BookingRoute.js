...
const { createBooking, getMyPlans, deleteByEmailAndTripId, getMyTrips, getPastTrips, getMyTripDetails, getTripHistoryDetails, getUserTripStatics,getApprovedBookingIds,getBookingById } = require('../controllers/BookingController')
